...
| cheatsheets — compressed tables | [../cheatsheets/ai-attack-vectors.md](../cheatsheets/ai-attack-vectors.md), [../cheatsheets/attack-to-control-mapping.md](../cheatsheets/attack-to-control-mapping.md), [../cheatsheets/tool-selection.md](../cheatsheets/tool-selection.md), `../cheatsheets/llm-test-case-library.md` | Fast recall: vector → pattern → defence, attack-to-control mapping for the paths above, tool choice under time pressure, and reusable test cases |
